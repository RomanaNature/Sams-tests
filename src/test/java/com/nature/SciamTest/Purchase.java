...
@Before
  ...
  public void testPurchase() throws Exception {
    //driver.get(baseUrl + "/store/subscribe/scientific-american-digital/?responseKey=");
    ...
    //new Select(driver.findElement(By.id("Select"))).selectByVisibleText("United States - $59.00");
    //select = new Select(driver.findElement(By.id(By.id("Select"))).selectByVisibleText("United States - $59.00");
    ...
    driver.findElement(By.id("emailAddress")).sendKeys("amasmith"+ran+"@yahoo.com");
    Thread.sleep(1000);
    driver.findElement(By.id("emailAddressConfirm")).clear();
    driver.findElement(By.id("emailAddressConfirm")).sendKeys("amasmith"+ran+"@yahoo.com");
    Thread.sleep(1000);
    ...
    driver.findElement(By.id("shippingStreetAddress")).sendKeys("198 34 43 st");
    Thread.sleep(1000);
